package com.Yu.Pan.core.generator.plugin;
...
public class FieldAttributePlugin extends PluginAdapter {
    ...
    public List<GeneratedJavaFile> contextGenerateAdditionalJavaFiles(IntrospectedTable introspectedTable) {
        ...
        root.addImportedType("com.Yu.Pan.core.generator.help.DbField");
        root.addImportedType("com.Yu.Pan.core.generator.help.FieldResult");
        ...
        for (IntrospectedColumn column : allColumns) {
            ...
            Field field = new Field(varName,
                    new FullyQualifiedJavaType("com.Yu.Pan.core.generator.help.DbField"));
            ...
            setMethod.setReturnType(new FullyQualifiedJavaType("com.Yu.Pan.core.generator.help.FieldResult"));
